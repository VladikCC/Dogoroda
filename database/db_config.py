import os
from sqlalchemy import create_backend, Column, Integer, String, Float, DateTime
...
DATABASE_URL = os.environ.get(
    "DATABASE_URL", 
    "postgresql://vladik_admin:super_password@localhost:5432/dogoroda_base"
)
...
class Product(Base):
    ...
    #string for parsing
    shop_product_id = Column(String, index=True)      # ID items
    ...
    updated_at = Column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow) # time for last parsing price
